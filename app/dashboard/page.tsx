...
export default function DashboardPage() {
  ...
  const greeting =
    hour < 12 ? t.page_dashboard_greeting_morning : hour < 18 ? t.page_dashboard_greeting_afternoon : t.page_dashboard_greeting_evening;
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
              <StatCard
                label={t.page_dashboard_today_sessions}
              ...
              />
              <StatCard
                label={t.page_dashboard_total_sessions}
                value={sessions.length.toString()}
                sub="all time"
              />
              <StatCard
                label={t.page_dashboard_focus_time}
                value={`${Math.round(totalMinutes / 60)}h`}
                sub={`${totalMinutes} minutes total`}
              />
              <StatCard
                label={t.page_dashboard_documents}
